...
public class SaferootModItems {
	...
	public static final DeferredItem<Item> VACHE_EN_ROOTIUM_SPAWN_EGG;
	public static final DeferredItem<Item> COCHON_ROOTIUM_SPAWN_EGG;
	public static final DeferredItem<Item> POULE_ROOTIUM_SPAWN_EGG;
	public static final DeferredItem<Item> SAPLING_ROOTIM;
	static {
		...
		VACHE_EN_ROOTIUM_SPAWN_EGG = REGISTRY.register("vache_en_rootium_spawn_egg", () -> new DeferredSpawnEggItem(SaferootModEntities.VACHE_EN_ROOTIUM, -1545712, -15253, new Item.Properties()));
		COCHON_ROOTIUM_SPAWN_EGG = REGISTRY.register("cochon_rootium_spawn_egg", () -> new DeferredSpawnEggItem(SaferootModEntities.COCHON_ROOTIUM, -27561, -11600, new Item.Properties()));
		POULE_ROOTIUM_SPAWN_EGG = REGISTRY.register("poule_rootium_spawn_egg", () -> new DeferredSpawnEggItem(SaferootModEntities.POULE_ROOTIUM, -20192, -5720, new Item.Properties()));
		SAPLING_ROOTIM = block(SaferootModBlocks.SAPLING_ROOTIM);
	}
