...
@Mod("saferoot")
public class SaferootMod {
	public static final Logger LOGGER = LogManager.getLogger(SaferootMod.class);
	public static final String MODID = "saferoot";

	public SaferootMod(IEventBus modEventBus) {
